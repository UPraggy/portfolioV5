...
export const PROJECTS: Project[] = [
  ...
  },
  {
    id: 'portfolio-v4',
    year: '2025',
    name: 'Portfolio V4 · Stencil.js',
    role: { pt: 'Próprio', en: 'Personal' },
    pitch: {
      pt: 'Versão anterior deste portfólio. Stencil.js + Web Components. Fonte do conteúdo que você está lendo.',
      en: 'Previous version of this portfolio. Stencil.js + Web Components. Source of the content you\'re reading.',
    },
    stack: ['Stencil.js', 'Web Components', 'TypeScript'],
  },
  {
    id: 'youtube',
    year: '2025—',
...
export const COMMAND_PALETTE: CmdItem[] = [
  ...
  { k: { pt: 'Abrir Portfólio v4', en: 'Open Portfolio v4' },s: 'Link',    href: 'https://rafaelmr.com.br' },
...
export const T = {
  ...
  ledgb: {
    ...
    sublabel: 'Autonomous Development Agent · v7.5' as Str,
  },
  projects: {
